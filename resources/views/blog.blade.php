...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        <div class="position-absolute bg-dark px-2 py-1 text-white" style="background-color: rgba(0, 0, 0, 0, 0.7 )">
        ...
        <div class="card-body">
          ...
          <p>
            <small class="text-muted">
              ...
              <a href="/blog?category={{ $post->category->slug }}"class="text-decoration-none">{{$post->category->name}}</a><br>
